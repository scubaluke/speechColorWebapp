...
function handleResult({
  ...
  let color = words.toLowerCase(); // strip spaces out

  color = color.replace(/\s/g, ''); // check if valid color

  if (!(0, _colors.isValidColor)(color)) return; // thats all
  ...
  console.log(color); // change background color
...
function start() {
  ...
  console.log('starting...'); // make new speech recognition
